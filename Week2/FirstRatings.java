...
public class FirstRatings {
    ...
    public ArrayList<Movie> loadMovies (String filename) {
        ...
        for (CSVRecord record:parser) {
            String currentID = String.valueOf(Integer.parseInt(record.get(0)));
            //test case System.out.println(currentID);
            ...
            //test case System.out.println(Integer.parseInt(record.get(0)) + " " + currentTitle);
    ...
    public ArrayList<Rater> loadRaters(String filename) {
        ...
        for (CSVRecord record:parser) {
            ...
            String imbdID = String.valueOf(Integer.parseInt(record.get(1)));;
